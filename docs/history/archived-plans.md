...
以下文档只保留历史决策与验收上下文，不再代表当前待办：

- [v0.8 实例化阴影与 HDR](../planning/instanced-shadow-hdr-roadmap.md)
- [v0.9 色彩与 Bloom](../planning/post-v0.8-roadmap.md)
- [v0.10 全 GPU 自动曝光](../planning/v0.10-gpu-auto-exposure.md)
- [v0.11 Retained-mode UI](../planning/v0.11-ui-subsystem.md)
