...
- Defined non-overlapping responsibilities for Minimal/LearnOpenGL/Async demos and added StressDemo with configurable triangle/quad/cube workloads, a reusable indexed cube, 100000-instance triangle/cube integrations, Nsight launcher, and CPU/GPU/present/state-cache metrics.
