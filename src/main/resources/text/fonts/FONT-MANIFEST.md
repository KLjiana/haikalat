...
- 本地资源：`/text/fonts/NotoSansSC-VF.ttf`
...
- 本地资源：`/text/fonts/unifont-17.0.05.otf`
...
- 本地资源：`/text/fonts/JetBrainsMono-Regular.ttf`
- 文件大小：273,900 bytes。
...
`BundledFonts` 管理。`FontManager` 继续只负责 native face 和字体族生命周期；
