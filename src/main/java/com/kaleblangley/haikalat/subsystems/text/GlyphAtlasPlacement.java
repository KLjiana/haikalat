...
public record GlyphAtlasPlacement(
    ...
    public float allocatedU0() {
        return (float) allocatedX() / pageWidth;
    }

    public float allocatedV0() {
        return (float) allocatedY() / pageHeight;
    }

    public float allocatedU1() {
        return (float) (allocatedX() + allocatedWidth()) / pageWidth;
    }

    public float allocatedV1() {
        return (float) (allocatedY() + allocatedHeight()) / pageHeight;
    }
