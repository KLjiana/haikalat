...
public final class BuiltinMeshData {
    ...
    private static final VertexLayout POSITION_COLOR = VertexLayout.interleaved(6 * Float.BYTES,
    ...
    private static final VertexLayout POSITION_UV = VertexLayout.interleaved(5 * Float.BYTES,
            VertexAttribute.builder().index(0).size(3).type(GL_FLOAT).offsetBytes(0).build(),
