...
import com.kaleblangley.haikalat.gl.mesh.VertexPacking;
import com.kaleblangley.haikalat.gl.render.RenderLoop;
...
public final class LearnOpenGlDemo {
    ...
    public static void main(String[] args) {
        ...
        AppWindow window = new AppWindow(1280, 720, "LearnOpenGL Demo");
        window.show();

        RenderLoop renderLoop = new RenderLoop(RenderSettings.builder().debugErrors(true).build());
